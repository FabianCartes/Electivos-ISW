  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <Card className="rounded-2xl p-8 mb-10 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="rounded-xl p-6 transform transition-all duration-300 flex flex-col hover:shadow-xl hover:-translate-y-2">
